...
var useragent = require('express-useragent');
var deploymentPackageRoot = path.normalize(__dirname + '/../..');
var queryLogMonitor = require(deploymentPackageRoot + '/middlewares/queryLogMonitor');
...
function setupExpressApp(app) {
    ...
    // Initialie Query Logger.
    queryLogMonitor.init(nconf);
    app.use(queryLogMonitor.monitorResponse);
