...
// {fact rule=insecure-tls-version@v1.0 defects=1}
    ...
    function insecureCryptographyNoncompliant()
{
    ...
    var req = https.request(options, (res: { on: (arg0: string, arg1: (d: any) => void) => void }) => {
        res.on('data', (d: any) => {
...
// {fact rule=insecure-tls-version@v1.0 defects=0}
var https = require("https")
